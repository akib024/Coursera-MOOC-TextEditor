...
public abstract class Document {
	...
	private String text;
	private List <Character> vowels = new ArrayList<>(Arrays.asList('a','e','i','o','u','y','A','E','I','O','U','Y'));
...
//					System.out.print(c+" ");
		...
		if(sequence_size > 1)
		{
			if(new_word[length-1] == 'e' && !vowels.contains(new_word[length-2]))
			{
				sequence_size -= 1;
//				System.out.println("----- ----- -----");
//				System.out.println(new_word[length-1]+" + "+new_word[length-2]);
//				System.out.println("_____ _____ _____");
	...
	public static boolean testCase(Document doc, int syllables, int words, int sentences)
	{
		...
		double flesch_score = doc.getFleschScore();
		...
		//System.out.println(flesch_score);
		return passed;
	}
	...
	public double getFleschScore()
	{
		...
		double flesch_score = 206.835;
		flesch_score -= 1.015 * this.getNumWords() / this.getNumSentences();
		flesch_score -= 84.6 * this.getNumSyllables() / this.getNumWords();
	    return flesch_score;
	}
