...
public class MarkovTextGeneratorLoL implements MarkovTextGenerator {
	...
	public void train(String sourceText)
	{
		...
		int wordQuantity = s.length;
		ListNode prevWordNode = null;
		
		for(int i = 1; i <= wordQuantity; i += 1)
		{
			boolean found = false;
			for(ListNode ln : wordList)
			{
				//System.out.println(ln.getWord());;
			...
			if(found)
			{
				prevWordNode.addNextWord(thisWord);
				//System.out.println(prevWordNode.getWord()+" er sathe "+thisWord+" add hoise.");
			}
			else
			{
				prevWordNode = new ListNode(prevWord);
				wordList.add(prevWordNode);
				//System.out.println(prevWordNode.getWord()+" create hoise.");
				prevWordNode.addNextWord(thisWord);
				//System.out.println(prevWordNode.getWord()+" er sathe "+thisWord+" add hoise.");
			}
			prevWord = thisWord;
	...
	public String generateText(int numWords) {
		...
		while(numWords-- > 0)
		{
			...
			{
//				System.out.println("currWord hoitase: "+currWord);
//				System.out.println("l.getWord: "+l.getWord());
				if(currWord.equals(l.getWord()))
				{
					currWordNode = l;
					break;
				}
